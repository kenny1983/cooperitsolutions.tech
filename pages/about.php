...
require __DIR__ . "../templates/header.php"; ?>
	...
	<div class="pt-3 row">
		<div class="col-md-8 content">
			...
			<p>I chose this career not for the money, but simply for the joy of creating something beautiful that actually works, and can be used by people of all ages and levels of tech-savviness. So please, take a look at my <a class="emphasis" href="portfolio.php">portfolio</a>, peruse my <a class="emphasis" href="resume.php">résumé</a> and if that all piques your interest, <a class="emphasis" href="contact.php">request a quote</a> from me for your next software development project. I promise you won't regret it!</p>
		</div>
